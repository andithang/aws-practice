              ...
              <div className="flex flex-nowrap items-center gap-2">
                <label className="text-sm">
                  <input
                    ...
                    className="block w-full rounded-lg border border-slate-300 px-3 py-1.5 text-sm text-slate-700 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-200"
                  />
                </label>
                <button
